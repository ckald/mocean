...
(function($) {
    var $background = $("<img />").addClass("vegas-background"),
        ...
        methods = {
            init: function(settings) {
                ...
                }).attr("src", options.src).attr("srcset", options.srcset);
                return $.vegas;
            },
            ...
            slideshow: function(settings, keepPause) {
                ...
                if (!paused) {
                    timer = setInterval(function() { doSlideshow(options); }, options.delay);
                }
                return $.vegas;
            },
            next: function() {
            ...
            resume: function() {
                ...
                paused = false;
                clearInterval(timer);
                $("body").trigger("vegasresume", [ $current.get(0), step - 1 ]);
                timer = setInterval(function() { doSlideshow(options); }, delay);
            },
            get: function(what) {
            ...
            preload: function(backgrounds) {
                ...
                for (var i in backgrounds) {
                    if (backgrounds[i].src) {
                        ...
                        cacheImage.srcset = backgrounds[i].srcset;
    ...
    function doSlideshow(options) {
        if (step < 0) {
            step = options.backgrounds.length - 1;
        }
        if (step >= options.backgrounds.length || !options.backgrounds[step - 1]) {
            step = 0;
        }
        var settings = options.backgrounds[step++];
